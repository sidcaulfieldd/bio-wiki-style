...
// Standalone scratch page (Reversed/Becca Primary Version).
export default function ScratchReversed() {
  ...
  // "pending" = gate showing. "correct" = picked Becca. "wrong" = picked Joel.
  ...
  useEffect(() => {
    ...
    // Default configuration reversed: Becca is primary
    const CONFIG = {
      frameFolder: "/becca",
      frameCount: 34,
      framePrefix: "frame_",
    ...
    video.addEventListener("loadedmetadata", positionVideoBox);
    ...
    (window as any).__applyPath = function applyPath(path: "joel" | "becca") {
      CONFIG.frameFolder = path === "becca" ? "/becca" : "/joel";
      CONFIG.frameCount = path === "becca" ? 34 : 35;
      video.src = path === "becca" ? "/becca/scratch-video-becca.mp4" : "/joel/scratch-video-joel.mp4";
      video.load();
      frames.length = 0;
      state.frameIndex = 0;
      preloadFrames().then(() => {
    ...
    return () => {
      ...
      video.removeEventListener("loadedmetadata", positionVideoBox);
  ...
  return (
    <div style={{ minHeight: "100vh", background: "#ffffff" }}>
      {gateChoice === "pending" && (
        ...
        >
          ...
          >
            ...
            {/* Reversed Buttons Order: Becca on Left, Joel on Right */}
      ...
      {/* Reversed Wrong-Path Message: Joel is clicked */}
      {gateChoice === "wrong" && (
        <div
          style={{
            height: "100vh",
        ...
        >
          <div style={{ ...sfPro, width: "fit-content", maxWidth: "90vw", display: "inline-block" }}>
            ...
            >
              <span>YOU'RE NOT JOEL, BUT</span>
              <br />
              <span>HERE'S WHAT I SENT HIM</span>
            </div>
      ...
      >
        ...
        >
          {/* Default video set to Becca */}
          <video
            ref={videoRef}
            src="/becca/scratch-video-becca.mp4"
            playsInline
            preload="auto"
            muted
            style={{
